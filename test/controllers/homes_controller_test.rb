...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference("Home.count") do
      post homes_url, params: { home: { position: @home.position, subtitle: @home.subtitle, title: @home.title } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { position: @home.position, subtitle: @home.subtitle, title: @home.title } }
